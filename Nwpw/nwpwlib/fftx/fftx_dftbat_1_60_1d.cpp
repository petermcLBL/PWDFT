...
void init_fftx_dftbat_1_60_1d() {
    for(int i3 = 0; i3 <= 9; i3++) {
        for(int i10 = 0; i10 <= 1; i10++) {
            D1[((4*i3) + (2*i10))] = cospi((((double )(118*(i3*i10))) / 60));
            D1[(1 + (4*i3) + (2*i10))] = sinpi((((double )(118*(i3*i10))) / 60));
        }
    }
    for(int i3 = 0; i3 <= 9; i3++) {
        for(int i10 = 0; i10 <= 1; i10++) {
            D2[((8*i3) + (4*i10))] = cospi((((double )(118*(i3*(2 + i10)))) / 60));
            D2[(1 + (8*i3) + (4*i10))] = sinpi((((double )(118*(i3*(2 + i10)))) / 60));
            D2[(2 + (8*i3) + (4*i10))] = cospi((((double )(118*(i3*(4 + i10)))) / 60));
            D2[(3 + (8*i3) + (4*i10))] = sinpi((((double )(118*(i3*(4 + i10)))) / 60));
        }
    }
}
...
void fftx_dftbat_1_60_1d(double  *Y, double  *X) {
    ...
    for(int i3 = 0; i3 <= 9; i3++) {
        ...
        s86 = ((0.5*t136) - (0.8660254037844386*t135));
        a256 = (a248 + 40);
        a257 = (a248 + 41);
        a258 = (a248 + 100);
        a259 = (a248 + 101);
        ...
        t139 = (*((X + a256)) - *((X + a258)));
        t140 = (*((X + a257)) - *((X + a259)));
        s87 = ((0.8660254037844386*t140) - (0.5*t139));
    ...
    for(int i2 = 0; i2 <= 5; i2++) {
        ...
        s202 = ((0.80901699437494745*t300) - (0.58778525229247314*t299));
        a504 = (a496 + 24);
        a505 = (a496 + 25);
        a506 = (a496 + 84);
        a507 = (a496 + 85);
        ...
        s204 = ((0.3090169943749474*t304) - (0.95105651629515353*t303));
        a508 = (a496 + 36);
        a509 = (a496 + 37);
        a510 = (a496 + 96);
        a511 = (a496 + 97);
        ...
        s205 = ((0.95105651629515353*t308) - (0.3090169943749474*t307));
        ...
        s207 = ((0.58778525229247314*t312) - (0.80901699437494745*t311));
        ...
        s213 = ((0.95105651629515353*t316) - (0.58778525229247314*t320));
        s214 = ((0.58778525229247314*t319) - (0.95105651629515353*t315));
        ...
        *((Y + a503)) = (s212 + s216);
        ...
        s221 = ((0.95105651629515353*t324) + (0.58778525229247314*t328));
        s222 = ((0.58778525229247314*t327) - (0.95105651629515353*t323));
        s223 = ((0.58778525229247314*t324) - (0.95105651629515353*t328));
        s224 = ((0.58778525229247314*t323) + (0.95105651629515353*t327));
        *((Y + a500)) = (t321 + t325 + t295);
        *((Y + a501)) = (t296 + t322 + t326);
        *((Y + a508)) = (s217 + s221);
        *((Y + a509)) = (s218 + s222);
        *((Y + a514)) = (s217 - s221);
        *((Y + a515)) = (s218 - s222);
