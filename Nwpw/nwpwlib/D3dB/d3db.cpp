   ...
   : Mapping3(inmaptype,inparall->np_i(),inparall->taskid_i(),nx,ny,nz)
{
   ...
   /* setup ffx */
   init_fftx_dftbat_1_60_1d();
   init_fftx_idftbat_1_60_1d();
   init_fftx_prdftbat_1_60_1d();
   init_fftx_iprdftbat_1_60_1d();
...
d3db::~d3db()
{
   ...
   // cleanup the FFTX library

   destroy_fftx_dftbat_1_60_1d();
   destroy_fftx_idftbat_1_60_1d();
   destroy_fftx_prdftbat_1_60_1d();
   destroy_fftx_iprdftbat_1_60_1d();
   ...
   if (maptype==1)
   {
       ...
       ***************************************************/
       ...
       for (q=0; q<nq; ++q)
       {
	     ...
	     if (ny==60) {
		fftx_idftbat_1_60_1d(tmp2,tmp2);
             } else {
       ...
       ************************************************/
       ...
       {
	     if (ny==60) {
		fftx_iprdftbat_1_60_1d(&a[indx],&a[indx]);
             } else {
...
void d3db::rc_fft3d(double *a)
{
   ...
   if (maptype==1)
   {
       ...
       ********************************************/
       ...
       {
	     if (nx==60) {
		fftx_prdftbat_1_60_1d(&a[indx],&a[indx]);
             } else {
